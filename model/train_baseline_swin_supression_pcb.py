...
def train_epoch_supression_pcb(epoch, data_loader, model, criterion, optimizer, opt,
    ...
    losses_BCE_W = AverageMeter() # cnn
    losses_BCE_s_3_W = AverageMeter() # trans
    ...
    for i, (imgs, gt_label, imgname) in enumerate(data_loader):
        ...
        if i % opt.print_freq == 0:
            print('Epoch: [{0}][{1}/{2}]\t'
                ...
                data_time=data_time, loss=total_loss, loss_BCE=losses_BCE_W, 
                loss_BCE_S_3=losses_BCE_s_3_W,loss_BCE_S_2=losses_BCE_s_2_W))
